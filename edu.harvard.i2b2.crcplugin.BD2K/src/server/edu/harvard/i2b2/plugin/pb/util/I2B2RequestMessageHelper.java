...
public class I2B2RequestMessageHelper {
	...
	public QueryDefinitionType getQueryDefinition() throws JAXBUtilException {
		...
		JAXBUtil jaxbUtil = CRCJAXBUtil.getJAXBUtil();
		JAXBElement analysisDef = jaxbUtil.unMashallFromString(requestXml);
		QueryDefinitionRequestType queryDefReqType = (QueryDefinitionRequestType) analysisDef.getValue();
